...
jQuery(function() {
  var $module = jQuery('#m-1609890292016').children('.module');
  $module.gfV3Product();
}); 
    
(function(jQuery) {
  var $module = jQuery('#m-1609890292016-0').children('.module');
  var effect = $module.attr('data-effect');
...
jQuery(function() {
  var $module = jQuery('#m-1609890292016-1').children('.module');
});
    
(function(jQuery) {
    var $module = jQuery('#m-1609890292016-2').children('.module');
    $module.gfV3ProductPrice({
        displayCurrency: true
    });
})(window.GemQuery || jQuery);
...
jQuery(function() {
  var $module = jQuery('#m-1609890292016-3').children('.module');
  $module.gfV3ProductCartButton({ onItemAdded: function(data) {}});
}); 
    
jQuery(function() {
  var $module = jQuery('#m-1609890512897').children('.module');
  $module.gfV3Product();
}); 
    
(function(jQuery) {
  var $module = jQuery('#m-1609890512897-0').children('.module');
  var effect = $module.attr('data-effect');
  var magnify = $module.attr('data-zoom-level');
  var displayType = $module.attr('data-displaytype');
  $module.gfV3ProductImage({
...
jQuery(function() {
  var $module = jQuery('#m-1609890512897-1').children('.module');
});
    
(function(jQuery) {
    var $module = jQuery('#m-1609890512897-2').children('.module');
    $module.gfV3ProductPrice({
        displayCurrency: true
    });
})(window.GemQuery || jQuery);
...
jQuery(function() {
  var $module = jQuery('#m-1609890512897-3').children('.module');
  $module.gfV3ProductCartButton({ onItemAdded: function(data) {}});
}); 
