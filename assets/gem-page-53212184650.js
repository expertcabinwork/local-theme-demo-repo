  ...
  if (mode == 'dev') {
      ...
      if (flag) {
          ...
          jQuery(function() {
  var $module = jQuery('#m-1603222617082').children('.module');
  $module.gfV3Product();
}); 
      
          jQuery(function() {
    var $module = jQuery('#m-1603222617082-0').children('.module');
    var effect = $module.attr('data-effect');
    $module.gfV3ProductImage({
        'effect': effect
          ...
          jQuery(function() {
  var $module = jQuery('#m-1603222617082-1').children('.module');
});
      
          jQuery(function() {
        var $module = jQuery('#m-1603222617082-2').children('.module');
        $module.gfV3ProductPrice({
          ...
          jQuery(function() {
  var $module = jQuery('#m-1603222617082-3').children('.module');
