...
(function( jQuery ){
  var $module = jQuery('#m-1661389266023').children('.module');
...
(function( jQuery ){
  var $module = jQuery('#m-1661389266023-child1').children('.module');
  $module.gfV3Product();
})( window.GemQuery || jQuery );
    
(function(jQuery) {
  var $module = jQuery('#m-1661389266023-child1-0').children('.module');
...
(function(jQuery) {
    var $module = jQuery('#m-1661389266023-child1-2').children('.module');
...
(function( jQuery ){
  var $module = jQuery('#m-1661389266023-child1-3').children('.module');
  $module.gfV3ProductCartButton({ onItemAdded: function(data) {}});
})( window.GemQuery || jQuery );
    
(function( jQuery ){
  var $module = jQuery('#m-1661389266023-child2').children('.module');
  $module.gfV3Product();
})( window.GemQuery || jQuery );
    
(function(jQuery) {
  var $module = jQuery('#m-1661389266023-child2-0').children('.module');
  var effect = $module.attr('data-effect');
  var magnify = $module.attr('data-zoom-level');
  var displayType = $module.attr('data-displaytype');
  $module.gfV3ProductImage({
...
(function(jQuery) {
    var $module = jQuery('#m-1661389266023-child2-2').children('.module');
    $module.gfV3ProductPrice({
        displayCurrency: true
    });
})(window.GemQuery || jQuery);
...
(function( jQuery ){
  var $module = jQuery('#m-1661389266023-child2-3').children('.module');
  $module.gfV3ProductCartButton({ onItemAdded: function(data) {}});
})( window.GemQuery || jQuery );
...
(function( jQuery ){
    var $module = jQuery('#m-1661297046956').children('.module');
