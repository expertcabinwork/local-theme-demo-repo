  ...
  if (mode == 'dev') {
      ...
      if (flag) {
          ...
          jQuery(function() {
  var $module = jQuery('#m-1595694325711').children('.module');
  var mode = jQuery('.gryffeditor').hasClass('editing') ? 'dev' : 'production';
  if(jQuery().gfYoutube) {
    $module.gfYoutube();
  }
          ...
          jQuery(function() {
  var $module = jQuery('#m-1595694343436').children('.module');
  var mode = jQuery('.gryffeditor').hasClass('editing') ? 'dev' : 'production';
  if(jQuery().gfYoutube) {
    $module.gfYoutube();
  }
          ...
          jQuery(function() {
  var $module = jQuery('#m-1595694346529').children('.module');
  var mode = jQuery('.gryffeditor').hasClass('editing') ? 'dev' : 'production';
  if(jQuery().gfYoutube) {
    $module.gfYoutube();
  }
          ...
          jQuery(function() {
  var $module = jQuery('#m-1595694349678').children('.module');
  var mode = jQuery('.gryffeditor').hasClass('editing') ? 'dev' : 'production';
  if(jQuery().gfYoutube) {
    $module.gfYoutube();
  }
