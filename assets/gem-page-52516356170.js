...
(function( jQuery ){
  var $module = jQuery('#m-1623277803823').children('.module');
  if(jQuery().gfYoutube) {
    $module.gfYoutube();
  }
    ...
    (function( jQuery ){
  var $module = jQuery('#m-1725909203383').children('.module');
  if(jQuery().gfYoutube) {
    $module.gfYoutube();
  }
})( window.GemQuery || jQuery );
...
(function( jQuery ){
  var $module = jQuery('#m-1623277825107').children('.module');
  if(jQuery().gfYoutube) {
    $module.gfYoutube();
  }
})( window.GemQuery || jQuery );
    ...
    (function( jQuery ){
  var $module = jQuery('#m-1725909372014').children('.module');
  if(jQuery().gfYoutube) {
    $module.gfYoutube();
  }
})( window.GemQuery || jQuery );
