        ...
        jQuery(function() {
            var $hero = jQuery('#m-1570091916633');
            var $module = jQuery('#m-1570091916633').children('.module');
          ...
          jQuery(function() {
  var $module = jQuery('#m-1602004658053').children('.module');

  var mode = jQuery('.gryffeditor').hasClass('editing') ? 'dev' : 'production';
  if(mode == 'production') { 
    $module.children('form').on('submit', function() {
      try {
        localStorage.setItem('gemId', '#m-1602004658053');
      } catch(err) {}
    });
