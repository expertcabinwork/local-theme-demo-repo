  ...
  if (mode == 'dev') {
    ...
    (function( jQuery ){
  // var $module = jQuery('#m-1730135395917').children('.module');
  // You can add custom Javascript code right here.
    ...
    (function( jQuery ){
  // var $module = jQuery('#m-1730135409105').children('.module');
  // You can add custom Javascript code right here.
})( window.GemQuery || jQuery );
    ...
    (function( jQuery ){
  // var $module = jQuery('#m-1730136743942').children('.module');
  // You can add custom Javascript code right here.
})( window.GemQuery || jQuery );
    ...
    (function( jQuery ){
  // var $module = jQuery('#m-1730137255888').children('.module');
  // You can add custom Javascript code right here.
})( window.GemQuery || jQuery );
  ...
  window.__gfFlowActions = []; window.__gfFlowActions.push([{"source":{"id":"#r-1730135395923"},"events":[{"key":"scrolling-in-view"}],"targets":[{"id":"#r-1598038787873","actions":[{"key":"scrollToId","type":2,"data":{"delay":0,"duration":500,"marginTop":30}}],"rename":"Row: #r-1598038787873"}]}]); window.__gfV1FlowActions.init();